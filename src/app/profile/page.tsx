  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-surface dark:bg-dark-surface py-12">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        {/* Profile Header */}
        <div className="bg-white dark:bg-dark-card rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-dark-border mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{session.name}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white dark:bg-dark-card rounded-2xl shadow-md p-6 border border-gray-100 dark:border-dark-border">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Travel Stats</h2>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Countries Visited</span>
                  <span className="text-lg font-bold text-primary">12</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Trips Completed</span>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white dark:bg-dark-card rounded-2xl shadow-md p-6 border border-gray-100 dark:border-dark-border">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Upcoming Trips</h2>
              {upcomingTrips.length > 0 ? (
                <div className="space-y-4">
                  {upcomingTrips.map((trip) => (
                    <div
                      key={trip.destination}
                      className="flex items-center justify-between p-4 rounded-xl bg-gray-50 dark:bg-dark-surface hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors"
                    >
                      <div>
            ...
            <div className="bg-white dark:bg-dark-card rounded-2xl shadow-md p-6 border border-gray-100 dark:border-dark-border">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Past Adventures</h2>
              <div className="space-y-4">
                {pastTrips.map((trip) => (
                  <div
                    key={trip.destination}
                    className="flex items-center justify-between p-4 rounded-xl bg-gray-50 dark:bg-dark-surface"
                  >
                    <div>
                      <h3 className="font-semibold text-gray-900 dark:text-white">{trip.destination}</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">{trip.date}</p>
